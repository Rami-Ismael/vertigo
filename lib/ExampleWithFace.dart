...
class ExampleWithFace extends StatefulWidget {
  final CameraDescription camera;

  const ExampleWithFace({Key key, this.camera}) : super(key: key);
  @override
  _CameraScreenState createState() => _CameraScreenState();
}

class _CameraScreenState extends State<ExampleWithFace> {
...
class _DetailScreenState extends State<DetailScreen> {
  ...
  void _initializeVision() async {
   ...
   // final VisionText visionText = await textRecognizer.processImage(visionImage);
    ...
    print("ahsfdjkhadjkfkhasdfkjgladsfghjgjhkfhjkgadgkjhfsadvghhjgkhjgkhjgkhjkhjkgjhkg");
    print(faces);
    String mailAddress = "";
        ...
        children: <Widget>[
          Center(
            child: Container(
              ...
              color: Colors.black,
              child: CustomPaint(
                foregroundPainter: FaceDectectorPainter(_imageSize,_faces),
                child:AspectRatio(
...
class FaceDectectorPainter extends CustomPainter {
  FaceDectectorPainter(this.absoluteImageSize, this.elements);
  ...
  @override
  bool shouldRepaint(FaceDectectorPainter oldDelegate) {
    return true;
  }
